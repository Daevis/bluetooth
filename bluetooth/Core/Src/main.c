...
/* Definitions for Temp_Measure */
osThreadId_t Temp_MeasureHandle;
const osThreadAttr_t Temp_Measure_attributes = {
  .name = "Temp_Measure",
  .stack_size = 128 * 4,
...
int main(void)
{
  ...
  /* creation of Temp_Measure */
  Temp_MeasureHandle = osThreadNew(Start_Temp_Measure, NULL, &Temp_Measure_attributes);

  /* creation of Send_Data */
  Send_DataHandle = osThreadNew(Start_Send_Data, NULL, &Send_Data_attributes);
...
/* USER CODE BEGIN Header_Start_Temp_Measure */
/**
* @brief Function implementing the Temp_Measure thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Start_Temp_Measure */
void Start_Temp_Measure(void *argument)
{
  /* USER CODE BEGIN Start_Temp_Measure */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END Start_Temp_Measure */
}

/* USER CODE BEGIN Header_Start_Send_Data */
/**
* @brief Function implementing the Send_Data thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Start_Send_Data */
void Start_Send_Data(void *argument)
{
  /* USER CODE BEGIN Start_Send_Data */
  /* Infinite loop */
  for(;;)
  {
